          ...
          <div className="relative mx-auto max-w-[1440px] px-8 lg:px-16">
            <div className="grid gap-16 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
              <div className="max-w-2xl">
                ...
                <h1 className="mt-6 text-[46px] font-extralight leading-[1.04] tracking-tight text-white sm:text-[58px] lg:text-[76px]">
                  Begin your smart home project in Abu Dhabi.
                </h1>
                <p className="mt-8 max-w-xl text-[16px] font-light leading-[1.8] text-white/68">
                ...
                <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                  <a
                    ...
                    className="group inline-flex items-center justify-center gap-3 bg-white px-8 py-4 text-[13px] tracking-[0.08em] text-black transition-all duration-300 hover:bg-white/90"
                  >
                    Email Smart Lit
                  ...
                  <Link
                    to="/projects"
                    className="group inline-flex items-center justify-center gap-3 border border-white/15 bg-white/[0.03] px-8 py-4 text-[13px] tracking-[0.08em] text-white transition-all duration-300 hover:border-white/35 hover:bg-white/5"
                  >
              ...
              <div className="rounded-[32px] border border-white/10 bg-white/[0.03] p-8 sm:p-10">
                <h2 className="text-[28px] font-extralight tracking-tight text-white sm:text-[34px]">
                  What to share
                </h2>
                <p className="mt-5 max-w-2xl text-[15px] font-light leading-[1.8] text-white/65">
                ...
                <div className="mt-8 grid gap-4">
                  {enquiryPoints.map((point) => (
                    ...
                    >
                      <p className="text-[15px] font-light leading-[1.6] text-white/82">
                        {point}
                      </p>
                    </div>
                  ))}
                ...
                <div className="mt-10 border-t border-white/10 pt-8">
                  ...
                  <p className="mt-3 text-[18px] font-extralight text-white">
                  ...
                  <a
                    ...
                    className="mt-3 inline-block text-[18px] font-extralight text-white hover:text-white/80"
                  >
                    {SITE_EMAIL}
                  </a>
                </div>
        ...
        <section className="bg-[#0a0a0a] py-24 lg:py-32">
          <div className="mx-auto grid max-w-[1440px] gap-8 px-8 lg:grid-cols-3 lg:px-16">
            <article className="rounded-[28px] border border-white/10 bg-white/[0.02] p-7">
              ...
              <h2 className="mt-5 text-[28px] font-extralight leading-[1.15] text-white">
                Calm, clear guidance from concept to handover.
              </h2>
              <p className="mt-5 text-[15px] font-light leading-[1.8] text-white/64">
