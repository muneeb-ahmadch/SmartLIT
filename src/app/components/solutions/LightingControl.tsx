...
export function LightingControl() {
  ...
  const modes = [
    "Morning and arrival scenes",
    "Evening and entertaining scenes",
    "Circadian comfort settings",
    "Away and security routines",
  ];
    ...
    <section ref={ref} className="relative bg-[#0a0a0a] overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-8 lg:px-16 py-24 lg:py-32">
        <div className="grid items-center gap-14 lg:min-h-screen lg:grid-cols-2 lg:gap-24">
          ...
          >
            ...
            <div className="space-y-6 text-white/65 text-[15px] lg:text-[16px] font-light leading-[1.8] mb-10">
              ...
              <p>
                ...
                warmth, and scene behaviour so architecture reads well from day
                to night.
              </p>
            </div>
            ...
            <div className="space-y-6 text-white/65 text-[15px] lg:text-[16px] font-light leading-[1.8]">
              ...
              <p className="text-white/85">
                For clients searching lighting control in Abu Dhabi, the real
                value is atmosphere with precision.
              </p>
            </div>
          </motion.div>
          ...
          >
          <img
            src="https://images.unsplash.com/photo-1757439402375-2f2a4ab0dc75?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjB2aWxsYSUyMGxpZ2h0aW5nJTIwZXZlbmluZ3xlbnwxfHx8fDE3NzM0MzQ5NDB8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
            alt="Luxury villa lighting"
